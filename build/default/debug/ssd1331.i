...
# 10 "D:\\Program Files\\Microchip\\xc8\\v3.00\\pic\\include\\c99/stdlib.h" 3
...
void SSD1331_Begin(SSD1331_t *ssd) {
    ...
    SSD1331_WriteCommand(ssd, 0xAE);
    SSD1331_WriteCommand(ssd, 0xA0);
    SSD1331_WriteCommand(ssd, 0x72);
    SSD1331_WriteCommand(ssd, 0xA1);
    SSD1331_WriteCommand(ssd, 0x00);
    SSD1331_WriteCommand(ssd, 0xA2);
    SSD1331_WriteCommand(ssd, 0x00);
    SSD1331_WriteCommand(ssd, 0xA4);
    SSD1331_WriteCommand(ssd, 0xA8);
    SSD1331_WriteCommand(ssd, 0x3F);
    SSD1331_WriteCommand(ssd, 0xAD);
    SSD1331_WriteCommand(ssd, 0x8E);
    SSD1331_WriteCommand(ssd, 0xB0);
    SSD1331_WriteCommand(ssd, 0x0B);
    SSD1331_WriteCommand(ssd, 0xB1);
    SSD1331_WriteCommand(ssd, 0x31);
    SSD1331_WriteCommand(ssd, 0xB3);
    SSD1331_WriteCommand(ssd, 0xF0);
    SSD1331_WriteCommand(ssd, 0x8A);
    SSD1331_WriteCommand(ssd, 0x64);
    SSD1331_WriteCommand(ssd, 0x8B);
    SSD1331_WriteCommand(ssd, 0x78);
    SSD1331_WriteCommand(ssd, 0x8C);
    SSD1331_WriteCommand(ssd, 0x64);
    SSD1331_WriteCommand(ssd, 0xBB);
    SSD1331_WriteCommand(ssd, 0x3A);
    SSD1331_WriteCommand(ssd, 0xBE);
    SSD1331_WriteCommand(ssd, 0x3E);
    SSD1331_WriteCommand(ssd, 0x87);
    SSD1331_WriteCommand(ssd, 0x06);
    SSD1331_WriteCommand(ssd, 0x81);
    SSD1331_WriteCommand(ssd, 0x91);
    SSD1331_WriteCommand(ssd, 0x82);
    SSD1331_WriteCommand(ssd, 0x50);
    SSD1331_WriteCommand(ssd, 0x83);
    SSD1331_WriteCommand(ssd, 0x7D);
    SSD1331_WriteCommand(ssd, 0xAF);

    SSD1331_FillScreen(ssd, 0x07FF);
}
...
void SSD1331_SetAddrWindow(SSD1331_t *ssd, uint16_t x, uint16_t y, uint16_t w, uint16_t h) {
    ...
    if (ssd->rotation & 1) {
        ...
        { int16_t t = x2; x2 = y2; y2 = t; };
    }

    SSD1331_WriteCommand(ssd, 0x15);
    SSD1331_WriteCommand(ssd, x1);
    SSD1331_WriteCommand(ssd, x2);

    SSD1331_WriteCommand(ssd, 0x75);
...
void SSD1331_DrawRect(SSD1331_t *ssd, int16_t x, int16_t y, int16_t w, int16_t h, uint16_t color) {
    SSD1331_WriteCommand(ssd, 0x26);
    SSD1331_WriteCommand(ssd, 0x00);

    SSD1331_WriteCommand(ssd, 0x22);
...
void SSD1331_EnableDisplay(SSD1331_t *ssd, _Bool enable) {
    SSD1331_WriteCommand(ssd, enable ? 0xAF : 0xAE);
}
